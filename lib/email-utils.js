...
const STMP_PORT = process.env.SMTP_PORT;
const SMTP_HOST = process.env.SMTP_HOST;
const STMP_USER = process.env.SMTP_USER;
const STMP_PASS = process.env.SMTP_PASS;
const TO_EMAIL = process.env.TO_EMAIL;

export let EMAIL_ENABLE = true;

if (!STMP_USER || !STMP_PASS || !TO_EMAIL) {
